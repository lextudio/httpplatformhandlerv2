...
Read Loop Design
-----------------
When a read IO completes successfully on any endpoints, HTTP Bridge Module doesn't
...
This prevents the need for data buffering at the HTTP Bridge Module level.
